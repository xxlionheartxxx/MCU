...
class MCUVideoMixer
{
  public:
    ...
    virtual BOOL ReadFrame(ConferenceMember & mbr, void * buffer, int width, int height, PINDEX & amount, unsigned type) = 0; //LDLac code
...
class MCUSimpleVideoMixer : public MCUVideoMixer
{
  public:
    ...
    virtual BOOL ReadFrame(ConferenceMember &, void * buffer, int width, int height, PINDEX & amount, unsigned type); //LDLac code
    ...
    virtual BOOL ReadMixedFrame(void * buffer, int width, int height, PINDEX & amount, unsigned type);//LDLac code
